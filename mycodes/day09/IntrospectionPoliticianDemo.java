...
public class IntrospectionPoliticianDemo {
	public static void main(String[] args)throws Exception {
		PoliceStation p1=(PoliceStation)Class.forName("mypac.PoliceStation").
				getConstructor(new Class[] {String.class}).newInstance("blablabla");
		Politician politician=(Politician)Class.forName("mypac.Politician").getConstructor().newInstance();
...
//		if(accused instance of Politician) {
//			Politician p=(Politician)accused;
//		}
//		else if(accused instance of BogusDoctor) {
//			
//		}
		//introspection
