...
<div class="container m-4 box">
	...
	<hr>	
	<form action="/ShoppingCartSpringMVC/shopping/shop3" method="post">
   <h1 class="text-danger">Vegetables Shop${customerMaster.getCustomerName()}</h1><hr>
	<table class="table">
	...
	<td><input type="checkbox" name="selected" value="${item.getItemid()}" <c:if test="${item.getItemStock()==0}">disabled="true"</c:if>></td>
		...
		<input type="submit" value="Next Shop" class="btn btn-danger mb-2 btn-block">
	</form>
</div>
