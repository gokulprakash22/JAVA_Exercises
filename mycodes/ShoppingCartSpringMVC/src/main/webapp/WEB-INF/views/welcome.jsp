...
<hr>
<h1>Welcome ${customerMaster.getCustomerName()}!! Lets Do Shopping</h1>
		<a href="/ShoppingCartSpringMVC/shopping/shop1"><button class="btn btn-primary mb-4">Go to shopping</button></a>
</div>
