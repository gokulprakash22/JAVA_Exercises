...
<div class="container m-4 box">
	...
	<form action="lang.do;jsessionid=<%=session.getId()%>" method="post" class="form-group">
	<input type="hidden" name="formid" value="lang">
		<select name="language" class="custom-select mb-2">
			<option value="ta">Tamil</option>
			<option value="en">English</option>
			<option value="te">Telugu</option>
			<option value="hi">Hindi</option>
		</select><br>
	<input type="submit" value="Select Language" class="btn btn-primary">
	</form>
</div>
