...
<div class="container m-4 box">
	...
	<hr>	
	<form action="/ShoppingCartSpringMVC/shopping/invoice" method="post">
   <h1 class="text-success">Fruits Shop</h1><hr>
	<table class="table">
	...
	<td><input type="checkbox" name="selected" value="${item.getItemid()}" <c:if test="${item.getItemStock()==0}">disabled="true"</c:if>></td>
		...
		<input type="submit" value="Generate Invoice" class="btn btn-success mb-2 btn-block">
	</form>
	</div>
