...
public class MainClass {
	public static void main(String[] args) throws ParseException {
		...
		customermasterdto.setCustomerno(2);
		customermasterdto.setCustomeraddress("Delhi");
		customermasterdto.setCustomeremail("mani@gmail.com");
		customermasterdto.setCustomername("Mani");
		customermasterdto.setCustomerphone("9876501234");
